...
- dashboard: realtime_cost_visibility
  ...
  - name: Service_Filter
    ...
    model: aws_billing
    explore: cur2
    listens_to_filters: [Account_Filter]
  ...
  - name: Region_Filter
    ...
    model: aws_billing
    explore: cur2
    listens_to_filters: [Service_Filter]
  ...
  - title: 🎯 Today vs Budget
    ...
    fields: [cur2.total_unblended_cost, cur2.budget_utilization_percentage]
    filters:
  ...
  - title: 📊 Projected Month-End
    ...
    explore: cur2
    type: single_value
    fields: [cur2.projected_month_end_cost]
    filters:
      cur2.line_item_usage_start_date: 'this month'
    limit: 1
    custom_color_enabled: true
  ...
  - title: ⏰ Hourly Spend Trend (Last 24 Hours)
    ...
    explore: cur2
    type: looker_area
    fields: [cur2.line_item_usage_start_hour, cur2.total_unblended_cost,
             cur2.total_usage_cost, cur2.total_amortized_cost]
    filters:
      cur2.line_item_usage_start_date: '24 hours'
  ...
  # =====================================================
  # MULTI-ACCOUNT VISIBILITY (CUR 2.0 Enhanced)
  # =====================================================
  ...
  - title: 🏢 Multi-Account Spend Distribution
    ...
    explore: cur2
    type: looker_grid
    fields: [cur2.line_item_usage_account_name, cur2.line_item_usage_account_id,
             cur2.total_unblended_cost, cur2.hour_over_hour_change,
             cur2.day_over_day_change, cur2.cost_anomaly_score]
    filters:
      cur2.line_item_usage_start_date: '24 hours'
    sorts: [cur2.total_unblended_cost desc]
    limit: 50
    ...
    - type: greater than
      ...
      font_color: '#dc2626'
      bold: true
      fields: [cur2.hour_over_hour_change]
    - type: greater than
      value: 75
      background_color: '#fef3c7'
      font_color: '#92400e'
  ...
  - title: 📊 Account Spend Heatmap
    ...
    explore: cur2
    type: looker_grid
    fields: [cur2.line_item_usage_account_name, cur2.line_item_usage_start_hour,
  ...
  # =====================================================
  # SERVICE-LEVEL REAL-TIME ANALYSIS
  # =====================================================
  ...
  - title: 🔧 Service Spend Rate (Last 6 Hours)
    ...
    explore: cur2
    type: looker_line
    fields: [cur2.line_item_usage_start_hour, cur2.line_item_product_code,
             cur2.total_unblended_cost]
    pivots: [cur2.line_item_product_code]
    filters:
      cur2.line_item_usage_start_date: '6 hours'
    sorts: [cur2.line_item_usage_start_hour, cur2.line_item_product_code]
    limit: 500
    column_limit: 10
    x_axis_gridlines: false
    y_axis_gridlines: true
  ...
  - title: 🌍 Regional Spend Distribution
    ...
    color_range: ['#dd3333', '#80ce5d', '#f78131', '#369dc1', '#c572d3', '#36c1b3', '#b57052', '#ed69af']
    color_application:
      collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2
      custom:
        id: regional-spend
  ...
  - title: 🚨 Real-Time Anomaly Alerts
    ...
    fields: [cur2.line_item_usage_start_time, cur2.line_item_product_code,
             cur2.line_item_usage_account_name, cur2.total_unblended_cost,
             cur2.cost_anomaly_score, cur2.anomaly_severity, cur2.expected_cost_range]
    filters:
